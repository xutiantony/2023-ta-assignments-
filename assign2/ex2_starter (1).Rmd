...
applications_test<-applications_test%>%select(-quarter,-Year,-Quarter)
```
...
# Assuming 'separation_indicator' is the response variable, and all other columns are predictors
